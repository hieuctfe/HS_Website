namespace RealEstate.Data
{
    ...
    public class CityGeneration : DataGeneration
    {
        public CityGeneration(_Context context) : base(context)
        {
            Generate();
        }
        ...
        private IEnumerable<string> _cities
            => new List<string> { "An Giang", "Bà Rịa–Vũng Tàu", "Bắc Giang", "Bắc Kạn", "Bạc Liêu", "Bắc Ninh", "Bến Tre",
                ...
                "Hải Dương", "Hải Phòng", "Hậu Giang", "Hồ Chí Minh", "Hòa Bình", "Hưng Yên", "Khánh Hòa",
        ...
        {
            _cities.ToList().ForEach(x => _context.Cities.AddOrUpdate(p => p.Name, new City { Name = x }));
